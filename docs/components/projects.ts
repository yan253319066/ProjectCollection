...
export const projects: Project[] = [
  ...
  },
  {
    ...
    taglineZh: '多链 Web3 量化交易 DApp 交付样板（含 Gold Digger 策略界面）',
    taglineEn: 'Multi-chain Web3 quant trading DApp sample, including the Gold Digger strategy UI',
    taglineJa: 'Gold Digger戦略UIを含むマルチチェーンWeb3クオンツ取引DAppのサンプル',
    taglineKo: 'Gold Digger 전략 UI를 포함한 멀티체인 Web3 퀀트 트레이딩 DApp 샘플',
    description: '',
    descriptionZh: '量化交易 DApp 交付样板：钱包连接、多链、策略档位界面（含 Gold Digger）与收益看板。用于展示交易类产品的前端与合约集成能力，不是对外理财产品。技术栈：React / Next.js、wagmi、Reown AppKit、Gemini API。',
    descriptionEn: 'A quantitative trading DApp sample: wallet connect, multi-chain support, strategy tiers (including Gold Digger), and a P&L dashboard. Built to show trading-product delivery — not an investment offering. Stack: React / Next.js, wagmi, Reown AppKit, Gemini API.',
    descriptionJa: 'クオンツ取引DAppのサンプル。ウォレット接続、マルチチェーン、Gold Diggerを含む戦略UI、収益ダッシュボード。取引プロダクトのデリバリー能力の展示であり、投資商品ではない。',
    descriptionKo: '퀀트 트레이딩 DApp 샘플: 지갑 연결, 멀티체인, Gold Digger 등 전략 UI, 수익 대시보드. 거래 제품 납품 능력을 보여 주기 위한 것이며 투자 상품이 아닙니다.',
  ...
  },
  {
    ...
    taglineZh: '多链 USDT 理财界面 DApp 交付样板',
    taglineEn: 'Multi-chain USDT earn-product UI — a DeFi delivery sample',
    taglineJa: 'マルチチェーンUSDT運用UIのDAppサンプル',
    taglineKo: '멀티체인 USDT 운용 UI DApp 샘플',
    description: '',
    descriptionZh: 'DeFi 理财类 DApp 交付样板：锁仓 / 活期档位、多链钱包、每日结算界面。用于展示收益类产品的合约与前端集成，不是对外承诺收益的理财产品。支持 15+ 链。',
    descriptionEn: 'A DeFi earn-product sample: lock / flexible tiers, multi-chain wallets, daily settlement UI. Built to show yield-product delivery — not a public APY offering. 15+ chains.',
    descriptionJa: 'DeFi運用DAppのサンプル。ロック/フレキシブル階層、マルチチェーンウォレット、日次決済UI。運用プロダクトのデリバリー展示であり、対外的な利回り約束ではない。',
    descriptionKo: 'DeFi 운용 DApp 샘플: 락업/유연 상품 UI, 멀티체인 지갑, 일일 정산 화면. 수익 상품 납품 능력을 보여 주기 위한 것이며 대외 수익률 약속이 아닙니다.',
