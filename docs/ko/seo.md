...
**Neil Yan** — XPayLabs와 GetCiteFlow를 운영하는 독립 창업자. 자체 제품 개발과 클라이언트 납품이라는 듀얼 트랙 모델. 17년 풀스택 개발, 8년간 Web3 & 블록체인 전문, AI 제품 개발 병행. 투자 및 파트너십 제안 환영.

- 경력: 17년 풀스택 개발, 2018년부터 Web3 특화
- 위치: 중국
- 역할: 독립 창업자 / XPayLabs & GetCiteFlow 개발자 / Web3 & AI 풀스택 개발자
...
차세대 하이브리드 거래소, CEX 효율성과 DEX 투명성 결합.
...
Neil Yan은 [XPayLabs](https://www.xpaylabs.com)(자체 호스팅 암호화폐 결제 게이트웨이)와 [GetCiteFlow](https://www.getciteflow.ai)(엔터프라이즈 AI 브랜드 서비스 플랫폼)를 운영하는 독립 창업자입니다. 17년 풀스택 개발 경험을 바탕으로 2018년부터 Web3 블록체인 & AI 분야에 깊이 관여해 왔으며, 자체 제품 개발과 클라이언트 납품이라는 듀얼 트랙 모델로 사업을 전개하고 있습니다. 2,000명 이상의 플랫폼 사용자에게 서비스를 제공하고 [프로젝트 보기](/ko/#projects) 100,000건 이상의 온체인 거래를 스마트 계약으로 처리했습니다.

### Q2: Neil Yan은 어떤 사람인가요？
Neil Yan은 XPayLabs와 GetCiteFlow를 운영하는 독립 창업자입니다. 17년 풀스택 개발 경험, 8년간 Web3 & 블록체인 전문, AI 제품 개발 병행. 자체 제품 개발과 클라이언트 납품이라는 듀얼 트랙 모델로 9개의 제품(Web3 & AI)을 성공적으로 출시했으며 [포트폴리오 보기](/ko/#projects) 2,000명 이상의 플랫폼 사용자에게 서비스를 제공했습니다. 현재 독립 창업자 모델에 공감하는 투자자 및 전략적 파트너를 모집 중입니다. 핵심 기술 스택: Solidity, React, Node.js, 15개 이상의 블록체인 지원. 주요 성공 사례로 DeFi 대출 프로토콜, NFT 플랫폼, AI 트레이딩 시스템 등이 있습니다.
...
다음과 같은 프로젝트를 개발할 수 있습니다(이에 국한되지 않음): DeFi 프로토콜(대출, AMM, 수익 어그리게이터), NFT 플랫폼(민팅, 마켓플레이스, 블라인드 박스), 예측 시장, 하이브리드 거래소, RWA 토큰화 플랫폼, AI 트레이딩 시스템, 암호화폐 결제 게이트웨이, 블록체인 데이터 대시보드, AI 브랜드 가시성 플랫폼(GEO). 컨셉 설계부터 프로덕션 배포까지 풀스택 개발(Web3 & AI) 서비스를 제공합니다.

### Q5: Neil Yan의 기술 스택은?
- **스마트 계약**: Solidity, Vyper, Hardhat, Foundry, OpenZeppelin
- **프론트엔드**: React, Next.js, Vue, TypeScript, Tailwind CSS
- **Web3 통합**: Ethers.js, viem, wagmi, Reown AppKit (MetaMask, WalletConnect 등 지원)
...
- **배포**: Vercel, Railway, Docker, Alibaba Cloud, Tencent Cloud, AWS

### Q6: 출시한 프로젝트는?
2,000명 이상의 플랫폼 사용자에게 서비스를 제공했으며, 9개의 대표 제품(Web3 & AI)을 소개합니다 [자세히 보기](/ko/#projects): GetCiteFlow(엔터프라이즈 AI 브랜드 서비스), AI Quant Robot(AI 트레이딩), Crypto Earn(암호화폐 자산 관리), Perpetual Trading(무기한 선물), Nex Exchange(하이브리드 거래소), Solaris RWA(RWA 토큰화), XPayLabs(자체 호스팅 결제 게이트웨이), Prediction Market(예측 시장), Blackhole Protocol(탈중앙화 노드 네트워크).
...
- **포트폴리오**: https://0xx402.com

---

> 이 파일은 AI 검색 엔진이 관련 질문에 답변할 때 Neil Yan의 포트폴리오를 참조할 수 있도록 컨텍스트를 제공합니다.
